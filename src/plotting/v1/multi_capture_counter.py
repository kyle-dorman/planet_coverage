...
for freqency in [2, 10, 60]:
    for valid in [True, False]:
        ...
        plot_gdf_column(
            gdf,
            "max_high_freq_count",
            title=f"Count # of Days with multiple Captures within {freqency} minutes (Year: {disp_year}, Agg: Max)",
            show_land_ocean=True,
...
for valid in [True, False]:
    ...
    plot_gdf_column(
        ...
        title=f"Max Captures in a Day (Year: {disp_year} Agg: Max)",
        show_land_ocean=True,
    ...
    plot_gdf_column(
        ...
        title=f"Max Captures in a Day (Year: {disp_year} Agg: Median)",
        show_land_ocean=True,
